...
class DetailFilmsScreen extends StatefulWidget {
  const DetailFilmsScreen({Key? key}) : super(key: key);

  @override
  State<DetailFilmsScreen> createState() => _DetailFilmsScreenState();
}

class _DetailFilmsScreenState extends State<DetailFilmsScreen> {
  @override
